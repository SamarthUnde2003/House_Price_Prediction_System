...
/**
 * Servlet implementation class viewAllProperty
 */
@WebServlet("/viewAllProperty")
public class viewAllProperty extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<div class='mt-3'>");
		out.println(
				"<select class='form-select ' id='locationoptions' name='locationget' aria-label='Floating label select example' onchange='fetchPrpertyOnLocationChange()' >");
